{{*<?*}}{{chr(60)}}?php
/**
 * $URL: svn://svn.subversion.ru/usr/local/svn/mzz/trunk/system/modules/admin/templates/generator/controller.save.tpl $
 *
 ...
 * @version $Id: controller.save.tpl 4015 2009-12-02 02:43:19Z mz $
 */
