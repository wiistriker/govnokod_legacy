...
<div id="footer" class="marginal">
    ...
    <div class="timer"><span style="float:left"><a href="http://www.mzz.ru/">{$smarty.const.MZZ_NAME}</a> (v.100500-{$smarty.const.MZZ_REVISION}) 2005-{"Y"|date} | <a href="http://www.mzz.ru/docs/">Documentation</a> | <a href="http://trac.mzz.ru">Trac</a></span> {$timer->toString('timer/admin/timer.tpl')}</div>
</div>